...
`,ef=`struct AdvancedBloomUniforms {
  uBloomScale: f32,
  uBrightness: f32,
};
...
`,rf=Object.defineProperty,sf=(n,e,t)=>e in n?rf(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Uo=(n,e,t)=>(sf(n,typeof e!="symbol"?e+"":e,t),t);const ko=class Bo extends D{constructor(e){e={...Bo.DEFAULT_OPTIONS,...e};const t=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:nf,entryPoint:"mainFragment"}}),r=L.from({vertex:V,fragment:tf,name:"extract-brightness-filter"});super({gpuProgram:t,glProgram:r,resources:{extractBrightnessUniforms:{uThreshold:{value:e.threshold,type:"f32"}}}}),Uo(this,"uniforms"),this.uniforms=this.resources.extractBrightnessUniforms.uniforms}get threshold(){return this.uniforms.uThreshold}set threshold(e){this.uniforms.uThreshold=e}};Uo(ko,"DEFAULT_OPTIONS",{threshold:.5});let of=ko;var af=Object.defineProperty,lf=(n,e,t)=>e in n?af(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,it=(n,e,t)=>(lf(n,typeof e!="symbol"?e+"":e,t),t);const uf=class Lo extends D{constructor(e){e={...Lo.DEFAULT_OPTIONS,...e};const t=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:ef,entryPoint:"mainFragment"}}),r=L.from({vertex:V,fragment:Jh,name:"advanced-bloom-filter"});super({gpuProgram:t,glProgram:r,resources:{advancedBloomUniforms:{uBloomScale:{value:e.bloomScale,type:"f32"},uBrightness:{value:e.brightness,type:"f32"}},uMapTexture:k.WHITE}}),it(this,"uniforms"),it(this,"bloomScale",1),it(this,"brightness",1),it(this,"_extractFilter"),it(this,"_blurFilter"),this.uniforms=this.resources.advancedBloomUniforms.uniforms,this._extractFilter=new of({threshold:e.threshold}),this._blurFilter=new Eo({strength:e.kernels??e.blur,quality:e.kernels?void 0:e.quality}),Object.assign(this,e)}apply(e,t,r,i){const s=pe.getSameSizeTexture(t);this._extractFilter.apply(e,t,s,!0);const o=pe.getSameSizeTexture(t);this._blurFilter.apply(e,s,o,!0),this.uniforms.uBloomScale=this.bloomScale,this.uniforms.uBrightness=this.brightness,this.resources.uMapTexture=o.source,e.applyFilter(this,t,r,i),pe.returnTexture(o),pe.returnTexture(s)}get threshold(){return this._extractFilter.threshold}set threshold(e){this._extractFilter.threshold=e}get kernels(){return this._blurFilter.kernels}set kernels(e){this._blurFilter.kernels=e}get blur(){return this._blurFilter.strength}set blur(e){this._blurFilter.strength=e}get quality(){return this._blurFilter.quality}set quality(e){this._blurFilter.quality=e}get pixelSize(){return this._blurFilter.pixelSize}set pixelSize(e){typeof e=="number"&&(e={x:e,y:e}),Array.isArray(e)&&(e={x:e[0],y:e[1]}),this._blurFilter.pixelSize=e}get pixelSizeX(){return this._blurFilter.pixelSizeX}set pixelSizeX(e){this._blurFilter.pixelSizeX=e}get pixelSizeY(){return this._blurFilter.pixelSizeY}set pixelSizeY(e){this._blurFilter.pixelSizeY=e}};it(uf,"DEFAULT_OPTIONS",{threshold:.5,bloomScale:1,brightness:1,blur:8,quality:4,pixelSize:{x:1,y:1}});var cf=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn unmapCoord(coord: vec2<f32> ) -> vec2<f32>
{
    ...
    mappedCoord /= gfu.uInputSize.xy;
    return mappedCoord;
}`,ff=Object.defineProperty,df=(n,e,t)=>e in n?ff(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Ir=(n,e,t)=>(df(n,typeof e!="symbol"?e+"":e,t),t);const pf=class Do extends D{constructor(...e){let t=e[0]??{};typeof t=="number"&&(I("6.0.0","AsciiFilter constructor params are now options object. See params: { size, color, replaceColor }"),t={size:t});const r=(t==null?void 0:t.color)&&t.replaceColor!==!1;t={...Do.DEFAULT_OPTIONS,...t};const i=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:hf,entryPoint:"mainFragment"}}),s=L.from({vertex:V,fragment:cf,name:"ascii-filter"});super({gpuProgram:i,glProgram:s,resources:{asciiUniforms:{uSize:{value:t.size,type:"f32"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uReplaceColor:{value:Number(r),type:"f32"}}}}),Ir(this,"uniforms"),Ir(this,"_color"),this.uniforms=this.resources.asciiUniforms.uniforms,this._color=new G,this.color=t.color??16777215}get size(){return this.uniforms.uSize}set size(e){this.uniforms.uSize=e}get color(){return this._color.value}set color(e){this._color.setValue(e);const[t,r,i]=this._color.toArray();this.uniforms.uColor[0]=t,this.uniforms.uColor[1]=r,this.uniforms.uColor[2]=i}get replaceColor(){return this.uniforms.uReplaceColor>.5}set replaceColor(e){this.uniforms.uReplaceColor=e?1:0}};Ir(pf,"DEFAULT_OPTIONS",{size:8,color:16777215,replaceColor:!1});var mf=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Kf=Object.defineProperty,Zf=(n,e,t)=>e in n?Kf(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Or=(n,e,t)=>(Zf(n,typeof e!="symbol"?e+"":e,t),t);const Qf=class Xo extends D{constructor(...e){let t=e[0]??{};(typeof t=="number"||Array.isArray(t)||t instanceof Float32Array)&&(I("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),t={color:t},e[1]!==void 0&&(t.alpha=e[1])),t={...Xo.DEFAULT_OPTIONS,...t};const r=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:qf,entryPoint:"mainFragment"}}),i=L.from({vertex:V,fragment:jf,name:"color-overlay-filter"});super({gpuProgram:r,glProgram:i,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:t.alpha,type:"f32"}}}}),Or(this,"uniforms"),Or(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new G,this.color=t.color??0}get color(){return this._color.value}set color(e){this._color.setValue(e);const[t,r,i]=this._color.toArray();this.uniforms.uColor[0]=t,this.uniforms.uColor[1]=r,this.uniforms.uColor[2]=i}get alpha(){return this.uniforms.uAlpha}set alpha(e){this.uniforms.uAlpha=e}};Or(Qf,"DEFAULT_OPTIONS",{color:0,alpha:1});var Jf=`in vec2 vTextureCoord;
out vec4 finalColor;
...
fn mainFragment(
    ...
    return finalColor;
}`,od=Object.defineProperty,ad=(n,e,t)=>e in n?od(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Ho=(n,e,t)=>(ad(n,typeof e!="symbol"?e+"":e,t),t);const ld=class jo extends D{constructor(...e){let t=e[0]??{};Array.isArray(t)&&(I("6.0.0","ConvolutionFilter constructor params are now options object. See params: { matrix, width, height }"),t={matrix:t},e[1]!==void 0&&(t.width=e[1]),e[2]!==void 0&&(t.height=e[2])),t={...jo.DEFAULT_OPTIONS,...t};const r=t.width??200,i=t.height??200,s=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:sd,entryPoint:"mainFragment"}}),o=L.from({vertex:V,fragment:id,name:"convolution-filter"});super({gpuProgram:s,glProgram:o,resources:{convolutionUniforms:{uMatrix:{value:t.matrix,type:"mat3x3<f32>"},uTexelSize:{value:{x:1/r,y:1/i},type:"vec2<f32>"}}}}),Ho(this,"uniforms"),this.uniforms=this.resources.convolutionUniforms.uniforms,this.width=r,this.height=i}get matrix(){return this.uniforms.uMatrix}set matrix(e){e.forEach((t,r)=>{this.uniforms.uMatrix[r]=t})}get width(){return 1/this.uniforms.uTexelSize.x}set width(e){this.uniforms.uTexelSize.x=1/e}get height(){return 1/this.uniforms.uTexelSize.y}set height(e){this.uniforms.uTexelSize.y=1/e}};Ho(ld,"DEFAULT_OPTIONS",{matrix:new Float32Array(9),width:200,height:200});var ud=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn interlaceLines(co: vec3<f32>, coord: vec2<f32>) -> vec3<f32>
{
  ...
  return color;
}`,hd=Object.defineProperty,fd=(n,e,t)=>e in n?hd(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,fn=(n,e,t)=>(fd(n,typeof e!="symbol"?e+"":e,t),t);const dd=class qo extends D{constructor(e){e={...qo.DEFAULT_OPTIONS,...e};const t=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:cd,entryPoint:"mainFragment"}}),r=L.from({vertex:V,fragment:ud,name:"crt-filter"});super({gpuProgram:t,glProgram:r,resources:{crtUniforms:{uLine:{value:new Float32Array(4),type:"vec4<f32>"},uNoise:{value:new Float32Array(2),type:"vec2<f32>"},uVignette:{value:new Float32Array(3),type:"vec3<f32>"},uSeed:{value:e.seed,type:"f32"},uTime:{value:e.time,type:"f32"},uDimensions:{value:new Float32Array(2),type:"vec2<f32>"}}}}),fn(this,"uniforms"),fn(this,"seed"),fn(this,"time"),this.uniforms=this.resources.crtUniforms.uniforms,Object.assign(this,e)}apply(e,t,r,i){this.uniforms.uDimensions[0]=t.frame.width,this.uniforms.uDimensions[1]=t.frame.height,this.uniforms.uSeed=this.seed,this.uniforms.uTime=this.time,e.applyFilter(this,t,r,i)}get curvature(){return this.uniforms.uLine[0]}set curvature(e){this.uniforms.uLine[0]=e}get lineWidth(){return this.uniforms.uLine[1]}set lineWidth(e){this.uniforms.uLine[1]=e}get lineContrast(){return this.uniforms.uLine[2]}set lineContrast(e){this.uniforms.uLine[2]=e}get verticalLine(){return this.uniforms.uLine[3]>.5}set verticalLine(e){this.uniforms.uLine[3]=e?1:0}get noise(){return this.uniforms.uNoise[0]}set noise(e){this.uniforms.uNoise[0]=e}get noiseSize(){return this.uniforms.uNoise[1]}set noiseSize(e){this.uniforms.uNoise[1]=e}get vignetting(){return this.uniforms.uVignette[0]}set vignetting(e){this.uniforms.uVignette[0]=e}get vignettingAlpha(){return this.uniforms.uVignette[1]}set vignettingAlpha(e){this.uniforms.uVignette[1]=e}get vignettingBlur(){return this.uniforms.uVignette[2]}set vignettingBlur(e){this.uniforms.uVignette[2]=e}};fn(dd,"DEFAULT_OPTIONS",{curvature:1,lineWidth:1,lineContrast:.25,verticalLine:!1,noise:0,noiseSize:1,vignetting:.3,vignettingAlpha:1,vignettingBlur:.3,time:0,seed:0});var pd=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
}`,gd=Object.defineProperty,xd=(n,e,t)=>e in n?gd(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,vd=(n,e,t)=>(xd(n,e+"",t),t);const yd=class Ko extends D{constructor(...e){let t=e[0]??{};typeof t=="number"&&(I("6.0.0","DotFilter constructor params are now options object. See params: { scale, angle, grayscale }"),t={scale:t},e[1]!==void 0&&(t.angle=e[1]),e[2]!==void 0&&(t.grayscale=e[2])),t={...Ko.DEFAULT_OPTIONS,...t};const r={uScale:{value:t.scale,type:"f32"},uAngle:{value:t.angle,type:"f32"},uGrayScale:{value:t.grayscale?1:0,type:"f32"}},i=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:md,entryPoint:"mainFragment"}}),s=L.from({vertex:V,fragment:pd,name:"dot-filter"});super({gpuProgram:i,glProgram:s,resources:{dotUniforms:r}})}get scale(){return this.resources.dotUniforms.uniforms.uScale}set scale(e){this.resources.dotUniforms.uniforms.uScale=e}get angle(){return this.resources.dotUniforms.uniforms.uAngle}set angle(e){this.resources.dotUniforms.uniforms.uAngle=e}get grayscale(){return this.resources.dotUniforms.uniforms.uGrayScale===1}set grayscale(e){this.resources.dotUniforms.uniforms.uGrayScale=e?1:0}};vd(yd,"DEFAULT_OPTIONS",{scale:1,angle:5,grayscale:!0});var _d=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn mainFragment(
  ...
  return color;
}`,Sd=Object.defineProperty,Cd=(n,e,t)=>e in n?Sd(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,ot=(n,e,t)=>(Cd(n,typeof e!="symbol"?e+"":e,t),t);const Zo=class Qo extends D{constructor(e){e={...Qo.DEFAULT_OPTIONS,...e};const t=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:bd,entryPoint:"mainFragment"}}),r=L.from({vertex:V,fragment:_d,name:"drop-shadow-filter"});super({gpuProgram:t,glProgram:r,resources:{dropShadowUniforms:{uAlpha:{value:e.alpha,type:"f32"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uOffset:{value:e.offset,type:"vec2<f32>"}}},resolution:e.resolution}),ot(this,"uniforms"),ot(this,"shadowOnly",!1),ot(this,"_color"),ot(this,"_blurFilter"),ot(this,"_basePass"),this.uniforms=this.resources.dropShadowUniforms.uniforms,this._color=new G,this.color=e.color??0,this._blurFilter=new Eo({strength:e.kernels??e.blur,quality:e.kernels?void 0:e.quality}),this._basePass=new D({gpuProgram:B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:`
                    @group(0) @binding(1) var uTexture: texture_2d<f32>; 
                    @group(0) @binding(2) var uSampler: sampler;
                    @fragment
                    fn mainFragment(
...
`,Wp=Object.defineProperty,Xp=(n,e,t)=>e in n?Wp(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,da=(n,e,t)=>(Xp(n,typeof e!="symbol"?e+"":e,t),t);const Yp=class pa extends D{constructor(e){e={...pa.DEFAULT_OPTIONS,...e};const t=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:Vp,entryPoint:"mainFragment"}}),r=L.from({vertex:V,fragment:$p,name:"twist-filter"});super({gpuProgram:t,glProgram:r,resources:{twistUniforms:{uTwist:{value:[e.radius??0,e.angle??0],type:"vec2<f32>"},uOffset:{value:e.offset,type:"vec2<f32>"}}},...e}),da(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(e){this.uniforms.uTwist[0]=e}get angle(){return this.uniforms.uTwist[1]}set angle(e){this.uniforms.uTwist[1]=e}get offset(){return this.uniforms.uOffset}set offset(e){this.uniforms.uOffset=e}get offsetX(){return this.offset.x}set offsetX(e){this.offset.x=e}get offsetY(){return this.offset.y}set offsetY(e){this.offset.y=e}};da(Yp,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var Hp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,qp=Object.defineProperty,Kp=(n,e,t)=>e in n?qp(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,ma=(n,e,t)=>(Kp(n,typeof e!="symbol"?e+"":e,t),t);const Zp=class ga extends D{constructor(e){e={...ga.DEFAULT_OPTIONS,...e};const t=e.maxKernelSize??32,r=B.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:jp.replace("${MAX_KERNEL_SIZE}",t.toFixed(1)),entryPoint:"mainFragment"}}),i=L.from({vertex:V,fragment:Hp.replace("${MAX_KERNEL_SIZE}",t.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:r,glProgram:i,resources:{zoomBlurUniforms:{uStrength:{value:e.strength,type:"f32"},uCenter:{value:e.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),ma(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,e)}get strength(){return this.uniforms.uStrength}set strength(e){this.uniforms.uStrength=e}get center(){return this.uniforms.uCenter}set center(e){Array.isArray(e)&&(e={x:e[0],y:e[1]}),this.uniforms.uCenter=e}get centerX(){return this.uniforms.uCenter.x}set centerX(e){this.uniforms.uCenter.x=e}get centerY(){return this.uniforms.uCenter.y}set centerY(e){this.uniforms.uCenter.y=e}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(e){this.uniforms.uRadii[0]=e}get radius(){return this.uniforms.uRadii[1]}set radius(e){this.uniforms.uRadii[1]=e<0||e===1/0?-1:e}};ma(Zp,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});const Ie=10,xe=10,Ut=16761095,xa="pig",ni="HarmonyOS_Sans_SC_Regular",va=48,Qp=[[16777215,0],[15495266,15158332],[6073826,5609927],[16043840,16101441],[11500228,10840509],[5756556,5488256]],Jp="version 1.6.0",em="星星王国",tm="开始游戏",nm=n=>`关卡: ${n}`,rm=n=>`目标: ${n}`;function ya(){let n=new wd;return n.color=4210752,n.alpha=.5,n.antialias="on",n.resolution=window.devicePixelRatio,n}function dt(n,e,t,r){n.clear(),n.filletRect(e.x,e.y,e.width,e.height,t),n.fill(r)}function _a(n,e,t){n.on("pointerdown",()=>t()),n.on("pointerup",()=>e()),n.on("pointerupoutside",()=>e())}class Sn{constructor(e,t){T(this,"width");T(this,"height");T(this,"yOffset",120);T(this,"gridY");T(this,"strokeSize");T(this,"padding",4);T(this,"contentWidth");T(this,"gridSize");T(this,"strokeHalf");T(this,"starPadding");T(this,"starSize");T(this,"outerR");T(this,"innerR");T(this,"fillet");this.width=e,this.height=t,this.gridY=t/2-e/2+this.yOffset/2,this.strokeSize=1,this.contentWidth=e-this.padding*2;const r=this.contentWidth;this.gridSize=(r-this.strokeSize*(xe+1))/xe,this.strokeHalf=this.strokeSize/2,this.starPadding=this.gridSize/24,this.starSize=this.gridSize-this.starPadding*2,this.outerR=this.starSize*15/32,this.innerR=this.outerR*18/32,this.fillet=this.starSize/5}}class im{constructor(e,t){T(this,"story");T(this,"group");T(this,"allStar",new Te);T(this,"tapArea",new Te);T(this,"scoreView",new ft);T(this,"levelView",new ft);T(this,"levelTargetView",new ft);T(this,"scaffoldCache",new qe(0,0));T(this,"cover",new Sn(0,0));this.story=e,this.group=t}create(){this.tapArea.zIndex=-1,this.group.addChild(this.tapArea),this.group.addChild(this.allStar),this.group.addChild(this.scoreView),this.group.addChild(this.levelView),this.group.addChild(this.levelTargetView)}build(e){this.scaffoldCache=e;const t=new Sn(e.width,e.height);this.cover=t;let r=this.tapArea;const i=t.padding,s=t.contentWidth,o=t.fillet,a=i,l=t.gridY+i;r.clear(),r.filletRect(a,l,s,s,o),r.fill(16777215),r.eventMode="static",r.removeAllListeners();const u=(e.width-i*2)/xe;r.on("pointertap",y=>{const _=Math.floor((y.globalX-a-this.group.x)/u),w=Math.floor((y.globalY-l-this.group.y)/u);console.log(`tap event: ${_} ${w}`),this.story.ofData().onGridTap(_,w)>1&&this.draw()}),this.draw();let c=new Te;c.zIndex=-1,this.group.addChild(c),c.rect(0,(t.height-t.width-t.yOffset)/2,t.width,t.yOffset);const h=this.scoreView,f=va,d=new ye({align:"center",fill:Ut,fontFamily:xa,fontSize:f,stroke:{color:8421504,width:1}});h.anchor=.5,h.resolution=window.devicePixelRatio,h.style=d,h.x=t.width/2;const p=t.height-t.width-t.yOffset+f;h.y=p/2+8;const g=7,m=new ye({fill:Ut,fontFamily:ni,fontSize:g*3}),v=this.levelView;v.anchor=0,v.resolution=window.devicePixelRatio,v.style=m,v.x=t.padding+8,v.y=(t.height-t.width+t.yOffset)/2-g*5;const x=this.levelTargetView;x.anchor=.5,x.resolution=window.devicePixelRatio,x.style=m,x.x=t.width/2,x.y=(t.height-t.width+t.yOffset)/2-g*3}draw(){console.log(`draw star, scaffold: ${this.scaffoldCache}`);const e=this.cover.gridY,t=this.cover.strokeSize,r=this.cover.padding,i=this.cover.gridSize,s=this.cover.strokeHalf,o=this.cover.starPadding,a=this.cover.starSize,l=this.cover.outerR,u=this.cover.innerR,c=this.cover.fillet,h=i+t,f=r+s+o,d=r+s+i/2;let p=this.story.ofData().ofGrids(),g=new Qe;this.allStar.clear();for(let m=0;m<Ie;m++)for(let v=0;v<xe;v++){let x=p[m][v].ofColor();if(x==0)continue;let y=Qp[x];const _=f+v*h,w=f+m*h+e;this.allStar.filters=[],this.allStar.filletRect(_,w,a,a,c),this.allStar.fill(y[1]);const R=d+v*h,A=d+m*h+e;this.drawStar(g,R,A,l,u,0),this.allStar.path(g),this.allStar.fill(y[0])}this.scoreView.text=this.story.ofData().ofScore(),this.levelView.text=this.story.ofData().ofLevel(),this.levelTargetView.text=this.story.ofData().ofLevelTarget()}destory(){this.tapArea.clear(),this.allStar.clear(),this.group.removeChild(this.tapArea),this.group.removeChild(this.allStar),this.group.removeChild(this.scoreView),this.group.removeChild(this.levelView),this.group.removeChild(this.levelTargetView)}drawStar(e,t,r,i,s,o){const a=u=>(36*u-o)/180*Math.PI;e.clear();const l=a(10);e.moveTo(t-Math.sin(l)*i,r-Math.cos(l)*i);for(let u=1;u<=10;u++){const c=u%2==1?s:i,h=t-Math.sin(a(u))*c,f=r-Math.cos(a(u))*c;e.lineTo(h,f)}e.closePath()}}class Fn{constructor(e,t,r,i){T(this,"x");T(this,"y");T(this,"width");T(this,"height");this.x=e,this.y=t,this.width=r,this.height=i}static only(e,t){return new Fn(0,0,e,t)}}class sm{constructor(e){T(this,"story");T(this,"app");T(this,"board");T(this,"group",new se);T(this,"endButton",new Te);T(this,"chessboard",new Te);this.story=e,this.app=e.ofApp(),this.board=new im(e,this.group)}create(){this.group.addChild(this.endButton),this.group.addChild(this.chessboard),this.app.stage.addChild(this.group),this.board.create()}build(e){this.group.x=e.x,this.group.y=e.y;const t=new Sn(e.width,e.height),r=8,s=(t.height-t.width-t.yOffset)/2+8,o=this.endButton;o.filters=[ya()],o.eventMode="static",o.removeAllListeners(),o.on("pointertap",()=>this.story.onPageChanged(0));const a=va-2,l=new Fn(r,s,a,a),u=8;dt(o,l,u,16777215),_a(o,()=>{dt(o,l,u,16777215)},()=>{dt(o,l,u,13421772)}),this.drawChessBoard(e.width,e.height),this.board.build(e)}update(e,t){this.group.x=e,this.group.y=t}show(){this.group.visible=!0}hide(){this.group.visible=!1}destory(){this.board.destory(),this.endButton.clear(),this.group.removeChild(this.endButton),this.group.removeChild(this.chessboard),this.app.stage.removeChild(this.group)}drawChessBoard(e,t){let r=this.chessboard;r.strokeStyle={color:15658734,width:1};const i=new Sn(e,t),s=i.gridY,o=i.strokeSize,a=i.padding,l=i.gridSize,u=i.strokeHalf;r.clear();for(let c=1;c<Ie;c++){const h=s+a+u+c*(l+o),f=a+u;r.moveTo(f,h);const d=e-a-u;r.lineTo(d,h)}for(let c=1;c<xe;c++){const h=a+u+c*(l+o),f=s+a+u;r.moveTo(h,f);const d=s+e-a-u;r.lineTo(h,d)}r.stroke()}}class om{constructor(){T(this,"allGrid",Array());T(this,"status",0);T(this,"score",0);T(this,"level",1)}init(){for(let e=0;e<Ie;e++){this.allGrid[e]=new Array;for(let t=0;t<xe;t++){let r=new am(0);r.setPivot(t,e),this.allGrid[e][t]=r}}}start(){this.loopGrid(e=>e.randomInit()),this.score=0,this.status=1}end(){this.loopGrid(e=>e.clear()),this.score=0,this.status=3}ofGrids(){return this.allGrid}ofScore(){return this.score}ofLevel(){return nm(this.level)}ofLevelTarget(){return rm(1e3)}isGaming(){return this.status==1}onGridTap(e,t){if(e<0||t<0||e>=xe||t>=Ie)return 0;let r=this.allGrid[t][e];if(r.isEmpty())return 0;let i=this.findSameColorGrids(r);if(i.length<=1)return 0;console.log(`total: ${i.length}`),i.forEach(a=>{console.log(`grid ${a[0]} ${a[1]}`),this.allGrid[a[0]][a[1]].clear()});for(let a=0;a<xe;a++){let l=0;for(let u=Ie-1;u>=0;u--)l>0&&this.allGrid[u+l][a].clone(this.allGrid[u][a]),this.allGrid[u][a].isEmpty()?l++:l>0&&this.allGrid[u][a].clear()}let s=0;for(let a=0;a<xe;a++)if(this.allGrid[Ie-1][a].isEmpty())s++;else if(s>0)for(let l=0;l<Ie;l++)this.allGrid[l][a-s].clone(this.allGrid[l][a]),this.allGrid[l][a].clear();const o=i.length;return this.score+=o*o*5,i.length}findSameColorGrids(e){let t=new Array,r=e.getPivot();console.log(`node ${r[1]} ${r[0]}`),t.push([r[1],r[0]]);let i=o=>{for(let a=0;a<t.length;a++){let l=t[a];if(l[0]==o[0]&&l[1]==o[1])return!1}return!0},s=0;for(;s<t.length;){let o=t[s],a=[o[0]-1,o[1]];a[0]>=0&&i(a)&&this.allGrid[a[0]][a[1]].equals(e)&&t.push(a);let l=[o[0]+1,o[1]];l[0]<Ie&&i(l)&&this.allGrid[l[0]][l[1]].equals(e)&&t.push(l);let u=[o[0],o[1]-1];u[1]>=0&&i(u)&&this.allGrid[u[0]][u[1]].equals(e)&&t.push(u);let c=[o[0],o[1]+1];c[1]<xe&&i(c)&&this.allGrid[c[0]][c[1]].equals(e)&&t.push(c),s++}return t}loopGrid(e){for(let t=0;t<Ie;t++)for(let r=0;r<xe;r++)e(this.allGrid[t][r])}}class am{constructor(e){T(this,"value");T(this,"dx");T(this,"dy");this.value=e,this.dx=0,this.dy=0}randomInit(){this.value=Math.ceil(Math.random()*5)}ofColor(){return this.value}getPivot(){return[this.dx,this.dy]}setPivot(e,t){this.dx=e,this.dy=t}clear(){this.value=0}equals(e){return this.value==e.value}isEmpty(){return this.value==0}clone(e){this.value=e.value}}class lm{constructor(e){T(this,"app");T(this,"story");T(this,"group",new se);T(this,"startButton",new Te);T(this,"title",new ft);T(this,"buttonText",new ft);this.story=e,this.app=e.ofApp()}create(){this.group.addChild(this.title),this.group.addChild(this.startButton),this.group.addChild(this.buttonText),this.app.stage.addChild(this.group);const e=this.title,t=new ye({align:"center",fill:16777215,fontFamily:xa,fontSize:84,stroke:{color:Ut,width:16}});e.anchor=.5,e.resolution=window.devicePixelRatio,e.style=t,e.text=em;const r=this.buttonText,i=new ye({align:"center",fill:16777215,fontFamily:ni,fontSize:24});r.anchor=.5,r.resolution=window.devicePixelRatio,r.style=i}build(e){this.group.x=e.x,this.group.y=e.y;const t=48,r=this.title;r.x=e.width/2,r.y=e.height/2-t*2;const i=t*2,s=e.height/2+t*2,o=e.width-t*4,a=48,l=this.buttonText;l.text=tm,l.x=e.width/2,l.y=s+a/2;const u=this.startButton;u.filters=[ya()],u.eventMode="static",u.removeAllListeners(),u.on("pointertap",()=>this.story.onGameStart());const c=new Fn(i,s,o,a),h=24;dt(u,c,h,Ut),_a(u,()=>{dt(u,c,h,Ut),l.style.fill=16777215},()=>{dt(u,c,h,15051776),l.style.fill=14540253})}update(e,t){this.group.x=e,this.group.y=t}show(){this.group.visible=!0}hide(){this.group.visible=!1}destory(){this.startButton.clear(),this.group.removeChild(this.startButton),this.app.stage.removeChild(this.group)}}const um=window.matchMedia("(prefers-color-scheme: dark)").matches,is=um?1:0;class cm{constructor(e){T(this,"app");T(this,"panel",new Te);this.app=e.ofApp()}create(){this.panel.zIndex=-2,this.app.stage.addChild(this.panel)}build(e=new qe(0,0)){const t=this.app.renderer,r=t.width,i=t.height,s=new xt(0,0,r,i);s.addColorStop(0,2895480),s.addColorStop(9/10,3943768),this.panel.rect(0,0,r,i).fill(s),this.panel.circle(0,i,Math.min(r,i)*2/5).fill(3743295)}update(e,t){}show(){this.panel.visible=!0}hide(){this.panel.visible=!0}destory(){this.app.stage.removeChild(this.panel)}redraw(){this.destory(),this.create(),this.build()}}class hm{constructor(){T(this,"app",new Qs);T(this,"databus",new om);T(this,"versionText",new ft);T(this,"background",new cm(this));T(this,"frontPanel",new lm(this));T(this,"contentPanel",new sm(this));T(this,"pageIndex",is);T(this,"lastPage",new fm);T(this,"scaffoldCache",new qe(0,0))}async start(){console.log(`eggcore: app start: ${window.devicePixelRatio}`);let e=this.app;await e.init({antialias:!0,autoDensity:!0,backgroundColor:6591981,resizeTo:window,resolution:window.devicePixelRatio}),e.ticker.add(()=>Nh()),document.body.appendChild(e.canvas),await ut.load("font/pig.otf"),await ut.load("font/HarmonyOS_Sans_SC_Regular.ttf"),this.databus.init(),is==1&&this.databus.start(),this.addVersionInfo(),this.onUpdate(qe.fromRenderer(this.app.renderer)),this.lastPage=this.showOnStatus();let t=e.renderer;t.addListener("resize",()=>this.onUpdate(qe.fromRenderer(t)))}ofApp(){return this.app}ofData(){return this.databus}onPageChanged(e){this.pageIndex=e,this.lastPage.destory();let t=this.showOnStatus();t.create(),t.build(this.scaffoldCache),this.lastPage=t,this.background.redraw()}onGameStart(){this.databus.start(),this.onPageChanged(1)}onGameEnd(){this.databus.end(),this.onPageChanged(0)}showOnStatus(){return this.pageIndex==0?this.frontPanel:this.pageIndex==1?this.contentPanel:this.frontPanel}onUpdate(e){let t=this.showOnStatus();e.sameSize(this.scaffoldCache)?t.update(e.x,e.y):(t.destory(),t.create(),t.build(e)),this.scaffoldCache=e;const r=5;this.versionText.x=this.app.renderer.width-r*2,this.versionText.y=this.app.renderer.height-r*2,this.background.redraw()}addVersionInfo(){const e=new ye({align:"center",fill:"#FFFFFF",fontFamily:ni,fontSize:14});this.versionText.anchor=1,this.versionText.resolution=window.devicePixelRatio,this.versionText.text=Jp,this.versionText.style=e,this.app.stage.addChild(this.versionText)}}class fm{create(){}build(e){}update(e,t){}show(){}hide(){}destory(){}}new hm().start();export{hu as $,qs as A,ue as B,se as C,J as D,O as E,D as F,B as G,yi as H,kt as I,Il as J,$l as K,te as L,X as M,ee as N,ou as O,oe as P,Si as Q,_n as R,Gl as S,Zt as T,Gs as U,cl as V,Dn as W,G as X,xs as Y,I as Z,Y as _,fr as a,Ou as a0,gt as a1,ye as a2,Sc as a3,zr as a4,lo as a5,Oi as a6,ji as a7,Fc as a8,Te as a9,Z as aa,Da as ab,Fr as ac,Yi as ad,xn as ae,co as af,_e as b,L as c,Wr as d,le as e,Cu as f,to as g,Ii as h,Tu as i,Gt as j,ln as k,Vr as l,Ys as m,Ps as n,be as o,Xi as p,k as q,Za as r,La as s,zu as t,Uu as u,Oe as v,ne as w,ms as x,pe as y,Pe as z};
